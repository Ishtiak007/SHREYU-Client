...
const Banner = () => {
    return (
        <div style={{ '--image-url': `url(${banner})` }}
            ...
            <div className="absolute bottom-0 left-0 right-0 top-0  overflow-hidden bg-fixed bg-black bg-opacity-75">
                <div className="w-full h-full flex justify-center items-center">
                    <Link to='/dashboard/advancedTables'><button className='buttonProject3'>Go To Dashboard</button></Link>
                </div>
            </div>
        </div>
    );
