                ...
                <div className="space-y-6 my-9">
                    ...
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="Some text value....." className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Default File Input :</span>
                            </label>
                            <FormInput type="file" placeholder="Default File Input" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    {/* email and date */}
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="email" placeholder="email" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Date :</span>
                            </label>
                            <FormInput type="date" placeholder="date" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    {/* password and month */}
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="password" placeholder="password" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Month :</span>
                            </label>
                            <FormInput type="month" placeholder="month" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="placeholder" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Time :</span>
                            </label>
                            <FormInput type="time" placeholder="time" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    {/* placeholder and time */}
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="textarea" className="textarea h-[100px] lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Week :</span>
                            </label>
                            <FormInput type="week" placeholder="week" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="read only value" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Numer :</span>
                            </label>
                            <FormInput type="number" placeholder="number" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="disabled value" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">URL :</span>
                            </label>
                            <FormInput type="url" placeholder="url" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    {/* specific  and secarh */}
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="specific control" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Search :</span>
                            </label>
                            <FormInput type="secarh" placeholder="search" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="text" placeholder="helping text" className="input lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
                                <span className="label-text text-[#4c4e60] font-bold text-base">Telephone :</span>
                            </label>
                            <FormInput type="tel" placeholder="+880" className="input lg:w-[65%]" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex items-center justify-between gap-10">
                        <div className="lg:flex lg:flex-1 items-center justify-between">
                            ...
                            <FormInput type="input" placeholder="helping text" className="select lg:w-[65%]" required />
                        </div>
                        <div className="lg:flex lg:flex-1 items-center  justify-between">
                            <label className="label">
